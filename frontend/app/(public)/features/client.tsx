...
export default function FeaturesPage() {
  ...
  return (
    <>
      <PageHero
        title="Engineered for High-Performance Teams."
        subtitle="Every capability is built to reduce friction and accelerate developer collaboration."
      />
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            },
            {
              icon: Users,
              label: 'Community',
              detail: '2,500+ active developers',
            },
            {
              icon: Sparkles,
              label: 'AI-Powered',
              detail: 'ML-driven match ranking',
            },
          ].map((s) => (
            <Card key={s.label}>
              <CardContent className="flex items-center gap-4 pt-6">
                <s.icon className="shrink-0 text-primary" size={24} />
                <div>
