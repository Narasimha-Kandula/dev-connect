...
export default function CallsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-6 py-10">
      <h1 className="text-2xl font-bold tracking-tight"><Phone size={20} className="mr-2 inline" /> Call History</h1>
          ...
          <Card key={c.id}>
            <CardContent className="flex items-center gap-4 pt-6">
              ...
              <div className="flex-1">
                <p className="font-semibold text-sm">{c.withName}</p>
              ...
              <Link href={`/collab/${c.id}`}><Button size="sm"><Phone size={14} className="mr-1" /> Call Back</Button></Link>
            </CardContent>
          </Card>
        ))}
      </div>
